<h2><a href="https://leetcode.com/problems/minimum-operations-to-form-subset-sum-ii/">4041. Minimum Operations to Form Subset Sum II</a></h2><h3>Hard</h3><hr><p>You are given an integer array <code>nums</code> and an integer <code>sum</code>.</p>
